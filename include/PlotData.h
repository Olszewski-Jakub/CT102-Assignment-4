...
/**
 * @brief Draws a bar plot of average time versus algorithm.
 *
 * This function takes five parameters: a pointer to a double array representing the average time, an integer representing the size of the array, two character pointers representing the title and y-axis label of the plot, and a character pointer representing the path to save the graph.
 *
 * @param avgTime A pointer to a double array representing the average time.
 * @param size The size of the array.
 * @param title The title of the plot.
 * @param yLabel The y-axis label of the plot.
...
/**
 * @brief Creates a bar plot series.
 *
...
/**
 * @brief Creates a scatter plot series.
 *
 ...
 *
 * This function takes eight parameters: two pointers to double arrays representing the x and y coordinates of the points, an integer representing the size of the arrays, and five character pointers representing the path to save the graph, the file name, the title of the plot, and the labels of the y and x axes.
 *
